...
describe('Singup Controller', () => {
  ...
  it('returns 400 if no password confirmation is provided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        email: 'any_email@mail.com',
  ...
  it('returns 400 if password  confirmation fails', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        email: 'any_email@mail.com',
  ...
  it('returns 400 if an invalid email is provided', async () => {
  ...
  it('returns 500 if EmailValidator throws', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  it('returns 500 if AddAccount throws', async () => {
